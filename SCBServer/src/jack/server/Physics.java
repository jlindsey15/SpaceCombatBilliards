...
public class Physics {
	...
	public static void collide(long index) {// Checks a pair of entities for
		...
		try {
			...
			e1.lastWallHit = 0;
			e2.lastWallHit = 0;
			if (e1 instanceof Spaceship)
				((Spaceship) e1).justHitWall = true;
			if (e2 instanceof Spaceship)
				((Spaceship) e2).justHitWall = true;
			if ((e1 instanceof Spaceship) && (e2 instanceof Billiard)) {
				((Spaceship) e1).hurt(1);
			}
			if ((e2 instanceof Spaceship) && (e1 instanceof Billiard)) {
				((Spaceship) e2).hurt(1);
			}
